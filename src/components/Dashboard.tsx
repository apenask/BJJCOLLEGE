...
export default function Dashboard({ onNavigate }: { onNavigate: (page: string) => void }) {
 ...
 codex/fix-typo-in-the-codebase
      ...
      setStats({
        receitaBruta: receita, totalComissoes: totalComissoesPagas, despesas: despesas, saldoLiquido: receita - despesas - totalComissoesPagas,
